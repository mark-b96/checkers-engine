...
class IKCalculations(object):
    def ik_calculations(self, square_row, square_column):
        ...
        if square_column < 4:
            waist_target = int(2100-waist_steps)
        else:
            waist_target = int(waist_steps+2100)
        shoulder_1_target = int(2048 - shoulder_steps+160)
        shoulder_2_target = int(shoulder_steps+2048-160)
